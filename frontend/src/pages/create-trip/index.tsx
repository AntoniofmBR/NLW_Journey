...
export default function CreateTripPage() {
  ...
  function addNewEmailsToInvite(event: FormEvent<HTMLFormElement>) {
    ...
    if (emailsToInvite.includes(email)) {
      return alert('Esse email já foi inserido')
    }
    ...
    <div className='h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center'>
      <div className='max-w-3xl w-full px-6 text-center space-y-10'>
        ...
        <p className='text-sm text-zinc-500'>
          ...
          <a href="#"className='text-zinc-300 underline'> politicas de privacidade</a>
        </p>
      </div>
      ...
      { isConfirmTripModalOpen && (
          <ConfirmTripModal
            ...
            startsDate={eventStartAndEndDates?.from?.getDate()}
            endsDate={eventStartAndEndDates?.to?.getDate()}
